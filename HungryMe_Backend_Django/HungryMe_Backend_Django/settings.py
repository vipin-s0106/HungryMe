"""
Django settings for HungryMe_Backend_Django project.
...
SECRET_KEY = 'p%ov@tcye+n8jq62pbbufyjlx!25&z_$ltn5tgbw$-xpnhc%=h'
...
ROOT_URLCONF = 'HungryMe_Backend_Django.urls'
...
WSGI_APPLICATION = 'HungryMe_Backend_Django.wsgi.application'
